...
import { parseAgentSessionKey, isSubagentSessionKey } from "../sessions/session-key-utils.js";
...
async function resolveSessionScopedUserProfileFile(params: {
  ...
  try {
    ...
    const relativeProfilePath = path
      .relative(params.workspaceDir, profilePath)
      .replaceAll(path.sep, "/");
    return {
      name: DEFAULT_USER_FILENAME,
      path: profilePath,
      contextPath: relativeProfilePath,
      content,
      missing: false,
    };
  } catch {
